...
function envio() {
  const mensagem = encodeURI(
    `Olá 😊.$Fiquei interessado no módulo para supermercados e mercearias do seu sistema, poderia me contar um pouco mais sobre?`
  )
  ...
  <main>
    <div class="container">
      ...
      <div class="container-right">
        <img src="@/assets/images/Servicos/SuperMercImagem.png" alt="" />
        <div class="chips">
          <div class="chips-top">
            <v-chip color="white" size="small" variant="outlined">Mercearias</v-chip>
            <v-chip color="white" size="small" variant="outlined">Supermercados</v-chip>
            <v-chip color="white" size="small" variant="outlined">Bolichos</v-chip>
          </div>
          <div class="chips-down">
            <v-chip color="white" size="small" variant="outlined"
              >Sacolão de Frutas e Verduras</v-chip
            >
            <v-chip color="white" size="small" variant="outlined">Mercadinhos</v-chip>
          </div>
        </div>
      </div>
    </div>
