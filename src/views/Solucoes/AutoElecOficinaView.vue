  ...
  <main>
    <div class="container">
      ...
      <div class="container-right">
        <img src="@/assets/images/Servicos/AutoElecOficinaImagem.png" alt="" />
        <div class="chips">
          <div class="chips-top">
            <v-chip color="white" size="small" variant="outlined">Oficinas</v-chip>
            <v-chip color="white" size="small" variant="outlined">Auto Elétricas</v-chip>
            <!-- <v-chip color="white" size="small" variant="outlined">Roupas Infantis</v-chip> -->
          </div>
          <div class="chips-down">
            <v-chip color="white" size="small" variant="outlined">Garagem</v-chip>
