  ...
  <main>
    <div class="container">
      ...
      <div class="container-right">
        <img src="@/assets/images/Servicos/FabPeqPorteImagem.png" alt="" />
        <div class="chips">
          <div class="chips-top">
            <v-chip color="white" size="small" variant="outlined">Confecções</v-chip>
            <v-chip color="white" size="small" variant="outlined">Lingerie</v-chip>
            <v-chip color="white" size="small" variant="outlined">Roupas Infantis</v-chip>
          </div>
          <div class="chips-down">
            <!-- <v-chip color="white" size="small" variant="outlined">Distribuidora de Água e Gás</v-chip> -->
            <!-- <v-chip color="white" size="small" variant="outlined">Martelinho de Ouro</v-chip> -->
            <!-- <v-chip color="white" size="small" variant="outlined">Estúdio</v-chip> -->
          </div>
        </div>
      </div>
    </div>
