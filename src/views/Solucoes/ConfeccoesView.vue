  ...
  <main>
    <div class="container">
      ...
      <div class="container-right">
        <img src="@/assets/images/Servicos/ConfeccoesImagem.png" alt="" />
        <div class="chips">
          <div class="chips-top">
            <v-chip color="white" size="small" variant="outlined">Confecções</v-chip>
            <v-chip color="white" size="small" variant="outlined">Estamparias</v-chip>
            <v-chip color="white" size="small" variant="outlined">Camiseterias</v-chip>
          </div>
          <div class="chips-down">
            <v-chip color="white" size="small" variant="outlined">Uniformes</v-chip>
            <v-chip color="white" size="small" variant="outlined">Costurarias</v-chip>
            <v-chip color="white" size="small" variant="outlined">Ateliês</v-chip>
          </div>
        </div>
      </div>
    </div>
