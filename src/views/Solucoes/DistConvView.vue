  ...
  <main>
    <div class="container">
      ...
      <div class="container-right">
        <img src="@/assets/images/Servicos/DistConvImagem.png" alt="" />
        <div class="chips">
          <div class="chips-top">
            <v-chip color="white" size="small" variant="outlined">Conveniência</v-chip>
            <v-chip color="white" size="small" variant="outlined">Mini-Mercado</v-chip>
            <v-chip color="white" size="small" variant="outlined">Armazém</v-chip>
          </div>
          <div class="chips-down">
            <v-chip color="white" size="small" variant="outlined"
              >Distribuidora de Água e Gás</v-chip
            >
